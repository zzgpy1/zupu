 ...
 */
export declare const isEdgeBase: <EdgeType extends EdgeBase = EdgeBase>(element: unknown) => element is EdgeType;
/**
 ...
 */
export declare const isNodeBase: <NodeType extends NodeBase = NodeBase>(element: unknown) => element is NodeType;
export declare const isInternalNodeBase: <NodeType extends InternalNodeBase = InternalNodeBase>(element: unknown) => element is NodeType;
/**
